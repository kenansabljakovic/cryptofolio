...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-8 px-1 text-left align-middle font-medium text-slate-500 dark:text-slate-400 sm:h-12 sm:px-4 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'px-1 py-3 align-middle sm:px-4 sm:py-4 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
