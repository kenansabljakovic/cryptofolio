...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-8 sm:h-12 px-1 sm:px-4 text-left align-middle font-medium text-slate-500 [&:has([role=checkbox])]:pr-0 dark:text-slate-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "py-3 px-1 sm:px-4 sm:py-4 align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
