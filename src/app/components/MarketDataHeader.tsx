  ...
  return (
    <div className="mx-auto flex w-full justify-center gap-2 bg-[#353570] px-4 py-5 dark:bg-[#1E1932] sm:gap-7 md:gap-8 lg:px-[72px]">
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs font-medium text-white">{globalMarketStats.active_cryptocurrencies}</span>
          </div>
          <div className="flex items-center gap-1">
            <ExchangeIcon />
          ...
          <div className="flex items-center gap-1">
            ...
            <span
              className={`hidden sm:inline sm:text-xs sm:font-medium ${
                globalMarketStats.market_cap_change_percentage_24h_usd > 0 ? 'text-[#00F0E2]' : 'text-[#FD2263]'
              }`}
            >
