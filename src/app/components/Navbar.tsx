...
export default function Navbar() {
  ...
  return (
    <div className="w-full bg-white dark:bg-[#13121A]">
      ...
      <div className="fixed bottom-0 left-0 z-50 flex w-full items-center justify-around border-t border-gray-200 bg-white/80 px-4 pb-[calc(0.5rem+env(safe-area-inset-bottom)*0.5)] pt-3 backdrop-blur-xl dark:border-transparent dark:bg-[#1A1A2E]/30 sm:hidden">
